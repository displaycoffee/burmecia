...
- index.html also contains a target for `#font-face-styles`, which sets the `font-face` styles before other styles

### Built with

[![Built with](https://skillicons.dev/icons?i=react,ts,js,css,sass,html,vite)](https://skillicons.dev)
